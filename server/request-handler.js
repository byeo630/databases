...
exports.requestHandler = function(request, response) {
  ...
  if (path.indexOf('message') !== -1) {
    ...
    response.end();
  } else if (path.indexOf('jquery') !== -1) {
    console.log(__dirname + '/../bower_components/jquery/dist/jquery.min.js', ' this is the dirname for jquery');
    var jq = fs.readFileSync(__dirname + '/../bower_components/jquery/dist/jquery.min.js');
    response.writeHead(200, {'Content-Type': 'text/javascript'});
    response.write(jq, 'utf8');
    response.end();
  } else if (path.indexOf('underscore') !== -1) {
    var us = fs.readFileSync(__dirname + '/../bower_components/underscore/underscore-min.js');
    response.writeHead(200, {'Content-Type': 'text/javascript'});
